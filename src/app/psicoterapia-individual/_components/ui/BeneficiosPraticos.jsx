...
export default function BeneficiosPraticos() {
  const beneficios = [
    "Reconhecer e compreender as raízes emocionais do seu sofrimento.",
    "Fortalecer sua autonomia emocional e clareza na expressão de sentimentos.",
    "Viver com mais autenticidade, leveza e equilíbrio.",
    "Ressignificar experiências que ainda impactam sua vida.",
    "Desenvolver novos recursos para lidar com estresse, ansiedade e sobrecarga.",
  ];
          ...
          <div className="w-full xl:w-[1400px] grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="border border-[#C2A66A]/20 rounded-xl p-6 flex flex-col justify-between backdrop-blur-[1px]">
              <p className="text-[#404040] text-[28px] mb-4">
                Se está difícil continuar como está, talvez seja o momento de
                começar.
              </p>
              <Link
